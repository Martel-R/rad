...
public class CadastroActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void onAuthSuccess(FirebaseUser user) {
        ...
        // Write new user
        writeNewUser(fUser.getUid(), username, fUser.getEmail(),false, fUser.isEmailVerified());
    ...
    // [START basic_write]
    private void writeNewUser(String userId, String name, String email, boolean adm, boolean verified) {
        User user = new User(name, email, adm, verified);
