                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SignInActivity.this, "Falha no login, crie uma nova conta",
        ...
        auth.sendPasswordResetEmail(email)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(SignInActivity.this, "Email de recuperação enviado",
    ...
    private void verificaEmail(){
        ...
        if (user!=null) {
            ...
            if (isEmailVerified) {
                ...
                FirebaseDatabase database = FirebaseDatabase.getInstance();
                DatabaseReference myRef = database.getReference("users");
                myRef.child(user.getUid()).child("verified").setValue(isEmailVerified);
//                user.sendEmailVerification()
//                        .addOnCompleteListener(new OnCompleteListener<Void>() {
//                            @Override
//                            public void onComplete(@NonNull Task<Void> task) {
//                                if (task.isSuccessful()) {
//                                    Toast.makeText(SignInActivity.this, "Email de verificação enviado",
//                                            Toast.LENGTH_SHORT).show();
//                                    Log.d(TAG, "Email verified sent.");
//                                }
//                            }
//                        });
